...
/**
 * FloatingParticles - Adds a premium, dynamic depth to the background.
 * Drifting document-like particles that move slowly across the screen.
 */
export const FloatingParticles: React.FC = () => {
    const frame = useCurrentFrame();

    // Create random stable positions for particles
        ...
        <AbsoluteFill className="pointer-events-none overflow-hidden opacity-50">
            {particles.map((p, i) => {
                ...
                return (
                    ...
                    >
                        {/* Abstract lines representing text on a document */}
